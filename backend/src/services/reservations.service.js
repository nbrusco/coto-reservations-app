...
export default class ReservationService {
  ...
  async getReservationsByEmail (email) {
    try {
      ...
      if (!reservations) { throw new Error(`No se encontraron reservas de ${email}`) }
  ...
  async appointReservation (reservation, email, name) {
    try {
      ...
      if (!newReservation) { throw new Error('No se pudo realizar la reserva. Intente nuevamente') }
